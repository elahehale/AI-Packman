    ...
    while True:
        ...
        if curr_state[0] not in visited:
            ...
            if problem.isGoalState(curr_state[0]):
                ...
                for s in successors:
                    if s[0] not in visited:
                        fringe.push((s[0], curr_state[1] + s[2], curr_state[2] + ',' + s[1]), curr_state[1] + s[2])
    x = x.split(",")
    x.pop(0)
    return x
            ...
            if problem.isGoalState(curr_state[0]):
                ...
                for s in successors:
                    if s[0] not in visited:
                        ...
                        fringe.push((s[0], curr_state[1] + s[2], curr_state[2] + ',' + s[1]), curr_state[1] + s[2] + h)
    x = x.split(",")
    x.pop(0)
    return x
